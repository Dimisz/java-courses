...
public class MoviesController {
  ...
  public ModelAndView getMovies() {
    // model.addAttribute("first", new Movie("Breaking Bad", "Ozymandias", 10.0));
    ...
    // 9.9));
    // model.addAttribute("fourth", new Movie("Star Wars: The Clone Wars", "Victory
    // and Death", 9.9));
    // model.addAttribute("fifth", new Movie("Mr. Robot", "407 Proxy Authentication
    // Required", 9.9));
    ...
    model.put("fourth", new Movie("Star Wars: The Clone Wars", "Victory and Death", 9.9));
    model.put("fifth", new Movie("Mr. Robot", "407 Proxy Authentication Required", 9.9));
